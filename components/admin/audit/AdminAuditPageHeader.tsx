...
import { ADMIN_AUDIT_BLUE, ADMIN_AUDIT_FONT } from './adminAuditStyles'

interface AdminAuditPageHeaderProps {
  title: string
  subtitle: string
  action?: React.ReactNode
}

export default function AdminAuditPageHeader({
  title,
  subtitle,
  action,
}: AdminAuditPageHeaderProps) {
  return (
...
export function AdminAuditPrimaryButton({
  children,
  onClick,
  className = '',
}: {
