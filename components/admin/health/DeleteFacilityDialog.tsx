  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-row gap-2 border-t border-[#EEF2F7] bg-[#FAFBFC] px-4 py-4 sm:gap-3 sm:px-6">
          <button
            type="button"
            disabled={loading}
            onClick={onClose}
            className="min-w-0 flex-1 rounded-xl border border-[#CBD5E1] bg-white py-2.5 text-xs font-bold text-[#475569] transition-colors hover:bg-[#F8FAFC] disabled:opacity-60 sm:py-3 sm:text-sm"
          >
            إلغاء
          </button>
          <button
            ...
            disabled={loading}
            onClick={onConfirm}
            className="flex min-w-0 flex-1 items-center justify-center gap-1.5 rounded-xl bg-[#EF4444] py-2.5 text-xs font-bold text-white transition-colors hover:bg-[#DC2626] disabled:cursor-not-allowed disabled:opacity-70 sm:gap-2 sm:py-3 sm:text-sm"
          >
            <Trash2 size={16} />
