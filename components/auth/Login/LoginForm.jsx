              ...
              <div className="space-y-1.5 sm:space-y-2">
                ...
                <div className="relative">
                  ...
                  <div className="pointer-events-none absolute top-1/2 right-4 flex -translate-y-1/2 items-center">
                    <i
                      className={`bx bx-envelope text-[18px] sm:text-[20px] ${isSubmitting ? 'text-[#459F49]' : 'text-[#2496FF]'}`}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-1.5 sm:space-y-2">
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-1/2 right-4 flex -translate-y-1/2 items-center">
                    <i
                      className={`bx bx-key text-[18px] sm:text-[20px] ${isSubmitting ? 'text-[#459F49]' : 'text-[#2496FF]'}`}
                    />
                  </div>
