      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center h-full">
        ...
        >
          <div className="w-full h-full flex flex-col items-center justify-between">
            ...
            <form onSubmit={onSubmit} noValidate className="w-full max-w-[580px] space-y-4 sm:space-y-5">
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <button type="button" onClick={onForgot} className="hover:opacity-80 transition-opacity font-bold text-[12px] sm:text-[14px]" style={{ color: '#E8B006', lineHeight: '100%' }}>نسيت كلمة المرور؟</button>
              </div>
