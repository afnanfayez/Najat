              ...
              <div className="space-y-1.5 sm:space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-11 rounded-[10px] border-none bg-white/95 pr-12 pl-4 text-right text-[14px] text-black shadow-[0px_4px_7.6px_0px_#0000001A] transition-all placeholder:text-gray-400 sm:h-[50px] sm:pr-14 sm:text-[15px]"
                  />
              ...
              <div className="space-y-1.5 sm:space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="********"
                    className="h-11 rounded-[10px] border-none bg-white/95 px-12 text-right text-[14px] text-black shadow-[0px_4px_7.6px_0px_#0000001A] transition-all placeholder:text-gray-400 sm:h-[50px] sm:px-14 sm:text-[15px]"
                  />
