  ...
  return (
    ...
    >
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, overflow: 'hidden', boxSizing: 'border-box' }}>
        ...
        {/* Body */}
        <div style={{ flex: 1, padding: '20px 28px', overflowY: 'auto', overflowX: 'hidden', display: 'flex', flexDirection: 'column', boxSizing: 'border-box' }}>
          {/* Emergency Banner */}
          <div
            style={{
              background: '#F44336',
          ...
          <div style={{ marginBottom: '16px', textAlign: 'right', flexShrink: 0 }}>
            <h3
              style={{
                fontFamily: "'Cairo', sans-serif",
                fontSize: '25px',
            ...
            <p style={{ 
              ...
              اختر الخدمة التي تحتاج إليه للبدء
            </p>
          </div>
