...
export default function HospitalMapView({ hospital, onBack }: { hospital: any, onBack: () => void }) {
  return (
    <div className="relative w-full h-full overflow-hidden" style={{ direction: 'rtl', fontFamily: "'Cairo', sans-serif" }}>
      <div className="absolute inset-0 bg-[#e5e7eb]">
        ...
        <div className="absolute top-[35%] right-[25%] flex items-center gap-2">
          ...
          <span className="text-amber-500 font-bold drop-shadow-md text-[15px]">{hospital?.address || 'غزة-الرمال-شارع الشهداء'}</span>
        </div>
