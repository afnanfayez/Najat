...
export default function ClinicDetailView({ clinic, onBack, onShowMap, onShowAllMedicines }: ClinicDetailViewProps) {
  return (
      ...
      <div className="flex-1 px-4 sm:px-6 pt-6 pb-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            <ClinicMedicinesSection onShowAll={onShowAllMedicines} />
